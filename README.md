...
local Window = Fluent:CreateWindow({Title = "❤️Tedhub❤️",SubTitle = "| By:Ted ",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = false,Theme = "Rose",MinimizeKey = Enum.KeyCode.End})
